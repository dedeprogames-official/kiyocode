...
brew install dedeprogames-official/tap/kiyocode # macOS と Linux（推奨。常に最新）
brew install opencode              # macOS と Linux（公式 brew formula。更新頻度は低め）
sudo pacman -S opencode            # Arch Linux (Stable)
paru -S opencode-bin               # Arch Linux (Latest from AUR)
mise use -g opencode               # どのOSでも
nix run nixpkgs#opencode           # または github:dedeprogames-official/kiyocode で最新 dev ブランチ
```
...
KiyoCode はデスクトップアプリとしても利用できます。[releases page](https://github.com/dedeprogames-official/kiyocode/releases) から直接ダウンロードするか、[kiyocode.ai/download](https://kiyocode.ai/download) を利用してください。
...
KiyoCode には組み込みの Agent が2つあり、`Tab` キーで切り替えられます。
...
[agents](https://kiyocode.ai/docs/agents) の詳細はこちら。

### ドキュメント

KiyoCode の設定については [**ドキュメント**](https://kiyocode.ai/docs) を参照してください。

### コントリビュート

KiyoCode に貢献したい場合は、Pull Request を送る前に [contributing docs](./CONTRIBUTING.md) を読んでください。

### KiyoCode の上に構築する

KiyoCode に関連するプロジェクトで、名前に "kiyocode"（例: "opencode-dashboard" や "opencode-mobile"）を含める場合は、そのプロジェクトが KiyoCode チームによって作られたものではなく、いかなる形でも関係がないことを README に明記してください。

---

**コミュニティに参加** [Discord](https://discord.gg/kiyocode) | [X.com](https://x.com/kiyocode)
