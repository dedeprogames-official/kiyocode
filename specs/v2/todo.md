...
The kiyocode server has moved to the Effect HttpApi backend. Remaining work is
...
- plugins get global "kiyocode" instance like in that post i showed
- kiyocode instance has stuff like `opencode.session.prompt()` or
