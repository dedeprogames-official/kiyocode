...
KiyoCode를 사용하면 여러 내장 테마 중 하나에서 선택할 수 있으며 terminal 테마에 적응하는 테마를 사용하거나 사용자 정의 테마를 정의 할 수 있습니다.

기본적으로 KiyoCode는 자체 `opencode` 테마를 사용합니다.
...
- KiyoCode가 터미널의 모양과 일치하기를 원하는 경우
...
KiyoCode는 사용자가 쉽게 테마를 만들고 사용자 정의할 수 있도록 유연한 JSON 기반 테마 시스템을 지원합니다.
