...
KiyoCode Go คือการสมัครสมาชิกในราคาประหยัด — **$5 สำหรับเดือนแรก** จากนั้น **$10/เดือน** — ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร

Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน KiyoCode คุณสามารถสมัครสมาชิก KiyoCode Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน KiyoCode
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่คัดเลือกมาเพื่อให้ทำงานร่วมกับ KiyoCode ได้เป็นอย่างดี
:::
...
KiyoCode Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$5 สำหรับเดือนแรก** จากนั้น **$10/เดือน**

---

## How it works

KiyoCode Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน KiyoCode

1. ลงชื่อเข้าใช้ที่ **<a href={console}>KiyoCode Zen</a>**, สมัครสมาชิก Go และคัดลอก API key ของคุณ
...
:::note
มีเพียงสมาชิกหนึ่งคนต่อ workspace เท่านั้นที่สามารถสมัครสมาชิก KiyoCode Go ได้
:::
...
KiyoCode Go มีขีดจำกัดดังต่อไปนี้:
...
[model id](/docs/config/#models) ใน KiyoCode config ของคุณจะใช้รูปแบบ `opencode-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K2.7 Code คุณจะใช้ `opencode-go/kimi-k2.7-code` ใน config ของคุณ
...
4. **ไม่ผูกขาดการใช้งาน (no lock-in)** โดยอนุญาตให้คุณใช้งานผู้ให้บริการรายอื่นๆ ร่วมกับ KiyoCode ได้เช่นกัน
