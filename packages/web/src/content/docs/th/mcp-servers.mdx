...
คุณสามารถเพิ่มเครื่องมือภายนอกให้กับ KiyoCode ได้โดยใช้ _Model Context Protocol_ หรือ MCP KiyoCode รองรับทั้งเซิร์ฟเวอร์ภายในและเซิร์ฟเวอร์ระยะไกล
...
คุณสามารถกำหนดเซิร์ฟเวอร์ MCP ได้ใน [KiyoCode Config](https://kiyocode.ai/docs/config/) ภายใต้ `mcp` เพิ่ม MCP แต่ละรายการด้วยชื่อที่ไม่ซ้ำใคร คุณสามารถอ้างอิงถึง MCP ด้วยชื่อได้เมื่อแจ้ง LLM
...
KiyoCode จะจัดการการตรวจสอบสิทธิ์ OAuth สำหรับเซิร์ฟเวอร์ MCP ระยะไกลโดยอัตโนมัติ เมื่อเซิร์ฟเวอร์ต้องการการรับรองความถูกต้อง KiyoCode จะ:
...
หากเซิร์ฟเวอร์ต้องมีการตรวจสอบสิทธิ์ KiyoCode จะแจ้งให้คุณตรวจสอบความถูกต้องเมื่อคุณพยายามใช้งานครั้งแรก หากไม่เป็นเช่นนั้น คุณสามารถ[ทริกเกอร์โฟลว์ด้วยตนเอง](#การตรวจสอบสิทธิ์) ด้วย `opencode mcp auth <server-name>`
...
คำสั่ง `mcp auth` จะเปิดเบราว์เซอร์ของคุณเพื่อขออนุญาต หลังจากที่คุณอนุญาตแล้ว KiyoCode จะจัดเก็บโทเค็นอย่างปลอดภัยใน `~/.local/share/opencode/mcp-auth.json`
...
MCP ของคุณพร้อมใช้งานในฐานะเครื่องมือใน KiyoCode ควบคู่ไปกับเครื่องมือในตัว คุณจึงสามารถจัดการผ่านการกำหนดค่า KiyoCode ได้เหมือนกับเครื่องมืออื่นๆ
...
ซึ่งจะเป็นการเปิดหน้าต่างเบราว์เซอร์เพื่อดำเนินการโฟลว์ OAuth ให้เสร็จสมบูรณ์ และเชื่อมต่อ KiyoCode กับบัญชี Sentry ของคุณ
