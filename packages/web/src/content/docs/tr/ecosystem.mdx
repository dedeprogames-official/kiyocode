---
title: Ekosistem
description: KiyoCode ile geliştirilen projeler ve entegrasyonlar.
---

KiyoCode üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
KiyoCode ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::

Ayrıca ekosistemi ve topluluğu bir araya getiren [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) ve [kiyocode.cafe](https://kiyocode.cafe) adreslerine de göz atabilirsiniz.
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | KiyoCode oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile KiyoCode kullanımını takip edin                                                                                  |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Arka plan aracıları, hazır LSP/AST/MCP araçları, seçilmiş aracılar, Claude Code uyumlu                                        |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | KiyoCode oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | KiyoCode bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | KiyoCode aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Görsel not alma ve özel/çevrimdışı paylaşım ile etkileşimli plan incelemesi                                                   |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | kiyocode /commands komutlarını, ayrıntılı akış kontrolü ile güçlü bir orkestrasyon sistemine genişletin                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | KiyoCode için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | KiyoCode için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, KiyoCode oturumlarını kontrol eden Discord botu       |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | API üzerine inşa edilmiş, editör farkındalıklı istemler için Neovim eklentisi   |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden KiyoCode için mobil öncelikli web arayüzü               |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | KiyoCode eklentileri oluşturmak için şablon                                     |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | kiyocode için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla KiyoCode kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | KiyoCode için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | KiyoCode'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | KiyoCode tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip KiyoCode eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | KiyoCode için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
