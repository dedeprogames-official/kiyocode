---
title: Web
description: Tarayıcınızda kiyocode'u kullanma.
---

kiyocode, tarayıcınızda bir web uygulaması olarak çalışabilir ve bir terminale ihtiyaç duymadan aynı güçlü AI kodlama deneyimini sağlayabilir.

![kiyocode Web - Yeni Oturum](../../../assets/web/web-homepage-new-session.png)
...
Bu, `127.0.0.1` üzerinde rastgele kullanılabilir bir bağlantı noktasına sahip yerel bir sunucuyu başlatır ve kiyocode'u varsayılan tarayıcınızda otomatik olarak açar.
...
kiyocode varsayılan olarak kullanılabilir bir bağlantı noktasını seçer. Bir bağlantı noktası belirtebilirsiniz:
...
Varsayılan olarak sunucu `127.0.0.1` (yalnızca localhost) öğesine bağlanır. kiyocode'u ağınızda erişilebilir kılmak için:

```bash
opencode web --hostname 0.0.0.0
```

`0.0.0.0` kullanıldığında, kiyocode hem yerel hem de ağ adreslerini gösterecektir:
...
Web arayüzü başlatıldığında kiyocode oturumlarınıza erişim sağlar.

### Oturum

Oturumlarınızı ana sayfadan görüntüleyin ve yönetin. Aktif oturumları görebilir ve yenilerini başlatabilirsiniz.

![kiyocode Web - Etkin Oturum](../../../assets/web/web-homepage-active-session.png)

### Sunucu Durumu

Bağlı sunucuları ve durumlarını görüntülemek için "Sunucuları Gör" seçeneğini tıklayın.

![kiyocode Web - Sunuculara bakın](../../../assets/web/web-homepage-see-servers.png)
