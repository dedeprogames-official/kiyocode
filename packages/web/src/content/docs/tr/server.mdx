---
title: Sunucu
description: kiyocode sunucusuyla HTTP uzerinden etkilesin.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

`opencode serve` komutu, kiyocode istemcisinin kullanabileceği bir OpenAPI endpoint'i açan headless bir HTTP sunucusu çalıştırır.
...
:::tip
kiyocode ile programatik etkileşim için kiyocode sunucusunu kullanın.
:::

Bu mimari, kiyocode'un birden fazla istemciyi desteklemesini ve programatik kullanımları mümkün kılmasını sağlar.

`opencode serve` ile bağımsız bir sunucu başlatabilirsiniz. kiyocode TUI açıksa, `opencode serve` yeni bir sunucu başlatır.
...
[`/tui`](#tui) uç noktası sunucu üzerinden TUI'yi sürmek için kullanılabilir. Örneğin bir istemi önceden doldurabilir veya çalıştırabilirsiniz. Bu kurulum kiyocode [IDE](/docs/ide) eklentileri tarafından kullanılır.
...
kiyocode sunucusu aşağıdaki API'leri sunar.
