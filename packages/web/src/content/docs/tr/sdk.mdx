---
title: SDK
description: kiyocode sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

kiyocode JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
kiyocode'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Halihazırda çalışan bir kiyocode örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
