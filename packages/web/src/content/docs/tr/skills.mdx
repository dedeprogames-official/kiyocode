...
Ajan becerileri, kiyocode'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
Proje yerel yollarinda kiyocode, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
...
kiyocode, `skill` araci aciklamasinda mevcut becerileri listeler.
