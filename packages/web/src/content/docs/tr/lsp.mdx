...
description: KiyoCode, LSP sunucularınızla bütünleşir.
---

KiyoCode, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

KiyoCode, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP etkinleştirildiğinde ve kiyocode bir dosyayı açtığında:
...
LSP sunucularını, kiyocode yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
