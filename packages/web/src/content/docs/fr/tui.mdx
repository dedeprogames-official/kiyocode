---
title: TUI
description: Utilisation de l’interface utilisateur du terminal KiyoCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KiyoCode fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de KiyoCode démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le KiyoCode TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à KiyoCode. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
- `leader_timeout` - Contrôle la durée pendant laquelle KiyoCode attend après la leader key. Valeur par défaut : `2000`.
