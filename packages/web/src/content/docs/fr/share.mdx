---
title: Partager
description: Partagez vos conversations KiyoCode.
---

La fonctionnalité de partage de KiyoCode vous permet de créer des liens publics vers vos conversations KiyoCode, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
Lorsque vous partagez une conversation, KiyoCode :
...
KiyoCode prend en charge trois modes de partage qui contrôlent la manière dont les conversations sont partagées :

---

### Manuel (par défaut)

Par défaut, KiyoCode utilise le mode de partage manuel. Les sessions ne sont pas partagées automatiquement, mais vous pouvez les partager manuellement à l'aide de la commande `/share` :
...
[En savoir plus](/docs/enterprise) sur l'utilisation de kiyocode dans votre organisation.
