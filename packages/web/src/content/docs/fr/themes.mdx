...
Avec KiyoCode, vous pouvez choisir parmi plusieurs thèmes intégrés, utiliser un thème qui s'adapte au thème de votre terminal ou définir votre propre thème personnalisé.

Par défaut, KiyoCode utilise notre propre thème `opencode`.
...
KiyoCode est livré avec plusieurs thèmes intégrés.
...
- Vous souhaitez que KiyoCode corresponde à l'apparence de leur terminal
...
KiyoCode prend en charge un système de thèmes flexible basé sur JSON qui permet aux utilisateurs de créer et de personnaliser facilement des thèmes.
...
{
  "$schema": "https://kiyocode.ai/theme.json",
  "defs": {
    "nord0": "#2E3440",
    "nord1": "#3B4252",
    "nord2": "#434C5E",
