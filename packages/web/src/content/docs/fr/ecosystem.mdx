---
title: Écosystème
description: Projets et intégrations construits avec KiyoCode.
---

Une collection de projets communautaires construits sur KiyoCode.

:::note
Vous souhaitez ajouter votre projet lié à KiyoCode à cette liste ? Soumettez une PR.
:::

Vous pouvez également consulter [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) et [kiyocode.cafe](https://kiyocode.cafe), une communauté qui regroupe l'écosystème et la communauté.
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions KiyoCode dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'KiyoCode avec Wakatime                                                                                            |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Agents d'arrière-plan, outils LSP/AST/MCP pré-construits, agents sélectionnés, compatible Claude Code                                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions KiyoCode                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte KiyoCode                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents KiyoCode le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Révision de plan interactive avec annotation visuelle et partage privé/hors ligne                                                      |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Étend kiyocode /commands en un système d'orchestration puissant avec contrôle de flux granulaire                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour KiyoCode – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour KiyoCode                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions KiyoCode, construit sur le SDK      |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Plugin Neovim pour des prompts conscients de l'éditeur, construit sur l'API |
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour KiyoCode via Tailscale/VPN                  |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins KiyoCode                                      |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Frontend Neovim pour kiyocode - un agent de codage IA basé sur terminal     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser KiyoCode via @opencode-ai/sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour KiyoCode                 |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre KiyoCode dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par KiyoCode         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions KiyoCode avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour KiyoCode            |
