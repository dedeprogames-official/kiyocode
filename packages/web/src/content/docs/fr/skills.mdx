...
Les compétences d'agent permettent à KiyoCode de découvrir des instructions réutilisables à partir de votre dépôt ou de votre répertoire personnel.
...
KiyoCode recherche ces emplacements :
...
Pour les chemins locaux du projet, KiyoCode remonte de votre répertoire de travail actuel jusqu'à ce qu'il atteigne l'arbre de travail git.
...
KiyoCode répertorie les compétences disponibles dans la description de l'outil `skill`.
