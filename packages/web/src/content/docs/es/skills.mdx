...
Las habilidades del agente permiten a KiyoCode descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
KiyoCode busca estas ubicaciones:
...
Para las rutas locales del proyecto, KiyoCode sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
...
KiyoCode enumera las habilidades disponibles en la descripción de la herramienta `skill`.
