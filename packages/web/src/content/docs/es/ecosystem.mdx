---
title: Ecosistema
description: Proyectos e integraciones construidas con KiyoCode.
---

Una colección de proyectos comunitarios construidos en KiyoCode.

:::note
¿Quieres agregar tu proyecto relacionado con KiyoCode a esta lista? Envíe un PR.
:::

También puedes consultar [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) y [kiyocode.cafe](https://kiyocode.cafe), una comunidad que agrega el ecosistema y la comunidad.
...
| Nombre                                                                                             | Descripción                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones KiyoCode en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Seguimiento del uso de KiyoCode con Wakatime                                                                                |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Agentes en segundo plano, herramientas LSP/AST/MCP prediseñadas, agentes seleccionados, compatible con Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificaciones de escritorio y alertas sonoras para sesiones KiyoCode                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto KiyoCode                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permitir que los agentes KiyoCode carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisión interactiva del plan con anotaciones visuales y uso compartido privado/sin conexión                                |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Amplíe kiyocode /commands a un potente sistema de orquestación con control de flujo granular                                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificaciones nativas del sistema operativo para KiyoCode: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Árboles de trabajo de Git de fricción cero para KiyoCode                                                                    |
...
| Nombre                                                                                     | Descripción                                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones KiyoCode, basado en el SDK                    |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Complemento Neovim para avisos compatibles con el editor, creado en API              |
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para KiyoCode a través de Tailscale/VPN                |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos KiyoCode                                           |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Interfaz de Neovim para kiyocode: un agente de codificación de IA basado en terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar KiyoCode a través de @opencode-ai/sdk              |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para KiyoCode                       |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Complemento de Obsidian que incorpora KiyoCode en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por KiyoCode            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones KiyoCode con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para KiyoCode               |
