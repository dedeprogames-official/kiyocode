...
Con KiyoCode puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, KiyoCode usa nuestro propio tema `opencode`.
...
KiyoCode viene con varios temas integrados.
...
- Quiere que KiyoCode coincida con la apariencia de su terminal
...
KiyoCode admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
