---
title: TUI
description: Usando la interfaz de usuario del terminal KiyoCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KiyoCode proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar KiyoCode se inicia TUI para el directorio actual.
...
Cuando utilice KiyoCode TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a KiyoCode. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de KiyoCode. _Alias_: `/quit`, `/q`
...
- `leader_timeout`: controla cuánto tiempo espera KiyoCode después de la leader key. El valor predeterminado es `2000`.
