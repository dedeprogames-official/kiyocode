---
title: Web
description: Usando KiyoCode en su navegador.
---

KiyoCode puede ejecutarse como una aplicación web en su navegador, brindando la misma poderosa experiencia de codificación de IA sin necesidad de una terminal.

![KiyoCode Web - Nueva sesión](../../../assets/web/web-homepage-new-session.png)
...
Esto inicia un servidor local en `127.0.0.1` con un puerto disponible aleatorio y abre automáticamente KiyoCode en su navegador predeterminado.
...
De forma predeterminada, KiyoCode elige un puerto disponible. Puede especificar un puerto:
...
De forma predeterminada, el servidor se vincula a `127.0.0.1` (solo localhost). Para hacer que KiyoCode sea accesible en su red:

```bash
opencode web --hostname 0.0.0.0
```

Al usar `0.0.0.0`, KiyoCode mostrará direcciones locales y de red:
...
Una vez iniciada, la interfaz web proporciona acceso a sus sesiones KiyoCode.

### Sesiones

Vea y administre sus sesiones desde la página de inicio. Puedes ver sesiones activas e iniciar otras nuevas.

![KiyoCode Web - Sesión activa](../../../assets/web/web-homepage-active-session.png)

### Estado del servidor

Haga clic en "Ver servidores" para ver los servidores conectados y su estado.

![KiyoCode Web - Ver Servidores](../../../assets/web/web-homepage-see-servers.png)
