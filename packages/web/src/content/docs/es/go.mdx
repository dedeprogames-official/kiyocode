...
KiyoCode Go es una suscripción de bajo costo — **$5 por tu primer mes**, luego **$10/mes** — que te brinda acceso confiable a modelos abiertos de programación populares.

Go funciona como cualquier otro proveedor en KiyoCode. Te suscribes a KiyoCode Go y
...
KiyoCode Go te da acceso a estos modelos por **$5 por tu primer mes**, luego **$10/mes**.

---

## Cómo funciona

KiyoCode Go funciona como cualquier otro proveedor en KiyoCode.

1. Inicias sesión en **<a href={console}>KiyoCode Zen</a>**, te suscribes a Go y
   copias tu API key.
...
:::note
Solo un miembro por espacio de trabajo puede suscribirse a KiyoCode Go.
:::
...
KiyoCode Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de KiyoCode
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con KiyoCode.
