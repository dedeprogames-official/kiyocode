...
Puede agregar comandos personalizados a través de la configuración KiyoCode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su KiyoCode [config](/docs/config):
...
kiyocode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
