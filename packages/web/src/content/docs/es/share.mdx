---
title: Compartir
description: Comparte tus conversaciones KiyoCode.
---

La función para compartir de KiyoCode te permite crear enlaces públicos a tus conversaciones de KiyoCode, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, KiyoCode:
...
KiyoCode admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, KiyoCode usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
[Obtenga más información](/docs/enterprise) sobre el uso de kiyocode en su organización.
