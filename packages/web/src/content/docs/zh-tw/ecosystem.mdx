---
title: 生態系統
description: 基於 KiyoCode 建置的專案與整合。
---

基於 KiyoCode 建置的社群專案合集。

:::note
想將您的 KiyoCode 相關專案新增到此列表中？歡迎提交 PR。
:::

您還可以查看 [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) 和 [kiyocode.cafe](https://kiyocode.cafe)，這是一個聚合生態系統與社群資源的社群。
...
| 名稱                                                                                               | 說明                                                                       |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔離的 Daytona 沙箱中自動執行 KiyoCode 工作階段，支援 git 同步和即時預覽 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追蹤 KiyoCode 的使用情況                                     |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | 背景代理、預建置的 LSP/AST/MCP 工具、精選代理，相容 Claude Code            |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | KiyoCode 工作階段的桌面通知和聲音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 針對權限請求、任務完成和錯誤事件的桌面通知與聲音提醒                       |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基於 KiyoCode 上下文的 AI 驅動自動 Zellij 工作階段命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允許 KiyoCode 代理透過技能發現和注入按需延遲載入提示詞                     |
| [opencode-supermemory](https://github.com/supermemoryai/opencode-supermemory)                      | 使用 Supermemory 實現跨工作階段的持久記憶                                  |
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | 支援視覺化標註和私有/離線分享的互動式計畫審查                              |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 將 KiyoCode /commands 擴展為具有精細流程控制的強大編排系統                 |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | KiyoCode 的原生作業系統通知——隨時了解任務完成情況                          |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | 捆綁式多代理編排套件——16 個元件，一次安裝                                  |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | KiyoCode 的零摩擦 git worktree 管理                                        |
...
| 名稱                                                                                       | 說明                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | 用於控制 KiyoCode 工作階段的 Discord 機器人，基於 SDK 建置    |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Neovim 外掛程式，提供編輯器感知的提示詞，基於 API 建置        |
| [portal](https://github.com/hosenur/portal)                                                | 透過 Tailscale/VPN 使用的行動優先 KiyoCode Web UI             |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用於建置 KiyoCode 外掛程式的範本                              |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | KiyoCode 的 Neovim 前端——基於終端機的 AI 編碼代理             |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 供應商，用於透過 @opencode-ai/sdk 使用 KiyoCode |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | KiyoCode 的 Web / 桌面應用程式和 VS Code 擴充功能             |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 將 KiyoCode 嵌入 Obsidian UI 的 Obsidian 外掛程式             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Claude Cowork 的開源替代方案，由 KiyoCode 驅動                |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | KiyoCode 擴充功能管理器，支援可攜式的隔離設定                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | KiyoCode 的桌面、Web、行動和遠端用戶端應用程式                |
