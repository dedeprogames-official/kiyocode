---
title: TUI
description: Korištenje korisničkog interfejsa KiyoCode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KiyoCode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje KiyoCode pokreće TUI za trenutni direktorij.
...
Kada koristite KiyoCode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u KiyoCode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz KiyoCode. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Kontroliše koliko dugo KiyoCode čeka nakon leader key. Podrazumijevano je `2000`.
