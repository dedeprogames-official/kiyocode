---
title: LSP serveri
description: KiyoCode se integriše sa vašim LSP serverima.
---

KiyoCode se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

KiyoCode dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i kiyocode otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj kiyocode konfiguraciji.
