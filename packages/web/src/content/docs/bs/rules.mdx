---
title: Pravila
description: Postavite prilagodena uputstva za kiyocode.
---

Mozete dodati prilagodena uputstva za kiyocode tako sto kreirate `AGENTS.md` datoteku. Ovo je slicno pravilima u Cursor-u. Sadrzi uputstva koja se ubacuju u LLM kontekst da prilagode ponasanje za vas projekat.

---

## Inicijalizacija

Da kreirate novu `AGENTS.md` datoteku, pokrenite `/init` komandu u kiyocode.

:::tip
Preporuceno je da `AGENTS.md` iz projekta commitujete u Git.
:::

Ovo skenira projekat i njegov sadrzaj, razumije cemu projekat sluzi i generise `AGENTS.md`. Tako kiyocode bolje navigira kroz kod.
...
kiyocode podrzava citanje `AGENTS.md` datoteke sa vise lokacija. Svaka lokacija ima drugu svrhu.
...
Mozete imati i globalna pravila u `~/.config/opencode/AGENTS.md`. Ona se primjenjuju u svim kiyocode sesijama.
...
Za korisnike koji prelaze sa Claude Code, KiyoCode podrzava i Claude konvencije datoteka kao rezervu:
...
Kada se kiyocode pokrene, trazi datoteke pravila ovim redoslijedom:
...
Iako kiyocode ne parsira automatski reference datoteka u `AGENTS.md`, slicno ponasanje mozete dobiti na dva nacina:
...
Mozete nauciti kiyocode da cita eksterne datoteke tako sto cete dati eksplicitna uputstva u `AGENTS.md`. Evo prakticnog primjera:
...
- Osigurate da kiyocode ucitava datoteke samo kad su potrebne za konkretan zadatak
