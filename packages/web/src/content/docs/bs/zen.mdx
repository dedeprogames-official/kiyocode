---
title: Zen
description: Kurirana lista modela koje nudi KiyoCode.
---
...
KiyoCode Zen je lista testiranih i provjerenih modela koje pruža KiyoCode tim.

Zen radi kao i svaki drugi provajder u KiyoCode. Prijavite se na KiyoCode Zen i
preuzmete svoj API ključ. To je **potpuno opcionalno** i ne morate ga koristiti
da biste koristili KiyoCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade s KiyoCode.
:::
...
KiyoCode Zen je AI gateway koji vam daje pristup tim modelima.

---

## Kako radi

KiyoCode Zen radi kao i svaki drugi provajder u KiyoCode.

1. Prijavite se na **<a href={console}>KiyoCode Zen</a>**, dodajte podatke za
   naplatu i kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI, izaberite KiyoCode Zen i zalijepite svoj API ključ.
...
[model id](/docs/config/#models) u vašoj KiyoCode konfiguraciji koristi format
...
- DeepSeek V4 Flash Free je dostupan na KiyoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- MiMo-V2.5 Free je dostupan na KiyoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- North Mini Code Free je dostupan na KiyoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Nemotron 3 Ultra Free je dostupan na KiyoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
- Big Pickle je stealth model koji je besplatan na KiyoCode ograničeno vrijeme. Tim koristi ovo vrijeme da prikupi povratne informacije i poboljša model.
...
4. Obezbijedimo **bez lock-ina** time što vam omogućavamo da ga koristite s bilo kojim drugim coding agentom. I da vam uvijek omogućimo da koristite bilo koji drugi provajder i u KiyoCode.
