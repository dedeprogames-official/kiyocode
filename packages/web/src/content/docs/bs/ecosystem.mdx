---
title: Ekosistem
description: Projekti i integracije izgrađeni uz KiyoCode.
---

Kolekcija projekata zajednice izgrađenih na KiyoCode.

:::note
Želite li na ovu listu dodati svoj KiyoCode projekat? Pošaljite PR.
:::

Također možete pogledati [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) i [kiyocode.cafe](https://kiyocode.cafe), zajednicu koja spaja ekosistem i zajednicu.
...
| Ime                                                                                                | Opis                                                                                                          |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatski pokrenite KiyoCode sesije u izoliranim Daytona sandboxovima uz git sinhronizaciju i preglede uživo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Pratite upotrebu KiyoCode sa Wakatime                                                                         |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Pozadinski agenti, unapred izgrađeni LSP/AST/MCP alati, kurirani agenti, kompatibilni sa Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Obavještenja na radnoj površini i zvučna upozorenja za KiyoCode sesije                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatsko imenovanje Zellij sesije na bazi KiyoCode konteksta                                                |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Dozvolite KiyoCode agentima da lijeno učitavaju upite na zahtjev uz otkrivanje vještina i ubrizgavanje        |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktivni pregled plana s vizualnim napomenama i privatnim/offline dijeljenjem                             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Proširite kiyocode /komande u moćan sistem orkestracije sa granularnom kontrolom toka                         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifikacije izvornog OS-a za KiyoCode – znajte kada se zadaci dovrše                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git radna stabla bez trenja za KiyoCode                                                                       |
...
| Ime                                                                                        | Opis                                                                  |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot za kontrolu KiyoCode sesija, izgrađen na SDK              |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Neovim dodatak za upite svjestan uređivača, izgrađen na API           |
| [portal](https://github.com/hosenur/portal)                                                | Mobilni korisnički interfejs za KiyoCode preko Tailscale/VPN          |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Predložak za izgradnju KiyoCode dodataka                              |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Neovim frontend za kiyocode - terminal baziran AI agent za kodiranje  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK dobavljač za korištenje KiyoCode putem @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App i VS Code Extension za KiyoCode                     |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian dodatak koji ugrađuje KiyoCode u Obsidian-ov UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa otvorenog koda Claudeu Coworku, pokretana pomoću KiyoCode |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | KiyoCode menadžer ekstenzija sa prenosivim, izolovanim profilima.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile i Remote Client aplikacija za KiyoCode           |
