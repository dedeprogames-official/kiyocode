---
title: Server
description: Komunicirajte s kiyocode serverom preko HTTP-a.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Komanda `opencode serve` pokrece headless HTTP server koji izlaže OpenAPI endpoint koji kiyocode klijent moze koristiti.
...
:::tip
Koristite kiyocode server za programsku interakciju sa opencode-om.
:::

Ova arhitektura omogucava kiyocode podrsku za vise klijenata i programsku interakciju.

Mozete pokrenuti `opencode serve` da startate standalone server. Ako je kiyocode TUI vec pokrenut, `opencode serve` ce pokrenuti novi server.
...
Endpoint [`/tui`](#tui) mozete koristiti za upravljanje TUI-jem kroz server. Na primjer, mozete unaprijed popuniti ili pokrenuti prompt. Ovaj setup koriste KiyoCode [IDE](/docs/ide) pluginovi.
...
kiyocode server izlaže sljedece API-je.
