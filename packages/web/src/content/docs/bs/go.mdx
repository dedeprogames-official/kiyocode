...
KiyoCode Go je povoljna pretplata — **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno** — koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u KiyoCode-u. Pretplatite se na KiyoCode Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili KiyoCode.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa KiyoCode-om.
:::
...
KiyoCode Go vam daje pristup ovim modelima za **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno**.

---

## Kako funkcioniše

KiyoCode Go radi kao bilo koji drugi provajder u KiyoCode-u.

1. Prijavite se na **<a href={console}>KiyoCode Zen</a>**, pretplatite se na Go i
...
:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na KiyoCode Go.
:::
...
KiyoCode Go uključuje sljedeća ograničenja:
...
[Model id](/docs/config/#models) u vašoj KiyoCode konfiguraciji
...
Napravili smo KiyoCode Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz KiyoCode koristite i bilo kojeg drugog provajdera.
