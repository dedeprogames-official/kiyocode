...
Agent skills omogucavaju KiyoCode da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
KiyoCode pretrazuje ove lokacije:
...
Za projektne lokalne putanje, KiyoCode ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
...
KiyoCode navodi dostupne skills u opisu `skill` alata.
