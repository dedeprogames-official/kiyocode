---
title: Suporte ACP
description: Use o kiyocode em qualquer editor compatível com ACP.
---

O kiyocode suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar kiyocode via ACP, configure seu editor para executar o comando `opencode acp`.

Este comando inicia o kiyocode como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'kiyocode' no seletor de agentes do AI Chat.
...
Para usar kiyocode como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar kiyocode como o agente ACP para chat.
...
O kiyocode funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do kiyocode
