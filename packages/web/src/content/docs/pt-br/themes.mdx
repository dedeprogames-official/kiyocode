...
Com o kiyocode, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.

Por padrão, o kiyocode usa nosso próprio tema `opencode`.
...
O kiyocode vem com vários temas embutidos.
...
- Querem que o kiyocode corresponda à aparência do seu terminal
...
O kiyocode suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
