---
title: Web
description: Usando o kiyocode no seu navegador.
---

O kiyocode pode ser executado como uma aplicação web no seu navegador, proporcionando a mesma poderosa experiência de codificação com IA sem precisar de um terminal.

![kiyocode Web - Nova Sessão](../../../assets/web/web-homepage-new-session.png)
...
Isso inicia um servidor local em `127.0.0.1` com uma porta aleatória disponível e abre automaticamente o kiyocode no seu navegador padrão.
...
Por padrão, o kiyocode escolhe uma porta disponível. Você pode especificar uma porta:
...
Por padrão, o servidor se vincula a `127.0.0.1` (apenas localhost). Para tornar o kiyocode acessível na sua rede:

```bash
opencode web --hostname 0.0.0.0
```

Ao usar `0.0.0.0`, o kiyocode exibirá endereços locais e de rede:
...
Uma vez iniciada, a interface web fornece acesso às suas sessões do kiyocode.

### Sessões

Visualize e gerencie suas sessões a partir da página inicial. Você pode ver sessões ativas e iniciar novas.

![kiyocode Web - Sessão Ativa](../../../assets/web/web-homepage-active-session.png)
