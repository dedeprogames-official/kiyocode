---
title: SDK
description: Cliente JS seguro em tipos para o servidor kiyocode.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do kiyocode fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o kiyocode programaticamente.
...
Crie uma instância do kiyocode:
...
Se você já tem uma instância do kiyocode em execução, pode criar uma instância de cliente para se conectar a ela:
