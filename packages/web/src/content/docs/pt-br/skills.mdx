...
As habilidades do agente permitem que o kiyocode descubra instruções reutilizáveis do seu repositório ou diretório pessoal.
...
O kiyocode pesquisa nesses locais:
...
Para caminhos locais do projeto, o kiyocode sobe a partir do seu diretório de trabalho atual até alcançar a árvore de trabalho do git.
...
O kiyocode lista as habilidades disponíveis na descrição da ferramenta `skill`.
