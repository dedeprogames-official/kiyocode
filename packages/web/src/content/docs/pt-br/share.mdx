---
title: Compartilhar
description: Compartilhe suas conversas do kiyocode.
---

O recurso de compartilhamento do kiyocode permite que você crie links públicos para suas conversas do kiyocode, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o kiyocode:
...
O kiyocode suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o kiyocode usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
[Saiba mais](/docs/enterprise) sobre como usar o kiyocode em sua organização.
