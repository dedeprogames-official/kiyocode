---
title: Servidor
description: Interaja com o servidor kiyocode via HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O comando `opencode serve` executa um servidor HTTP sem cabeça que expõe um endpoint OpenAPI que um cliente kiyocode pode usar.
...
:::tip
Use o servidor kiyocode para interagir com o kiyocode programaticamente.
:::

Essa arquitetura permite que o kiyocode suporte múltiplos clientes e permite que você interaja com o kiyocode programaticamente.

Você pode executar `opencode serve` para iniciar um servidor autônomo. Se você tiver o TUI do kiyocode em execução, `opencode serve` iniciará um novo servidor.
...
O endpoint [`/tui`](#tui) pode ser usado para controlar o TUI através do servidor. Por exemplo, você pode preencher ou executar um prompt. Essa configuração é usada pelos plugins do kiyocode [IDE](/docs/ide).
...
O servidor kiyocode expõe as seguintes APIs.
