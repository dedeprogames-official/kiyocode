...
O KiyoCode Go é uma assinatura de baixo custo — **US$ 5 no seu primeiro mês**, depois **US$ 10/mês** — que oferece acesso confiável a modelos abertos de programação populares.

O Go funciona como qualquer outro provedor no KiyoCode. Você assina o KiyoCode Go e
...
O KiyoCode Go lhe dá acesso a esses modelos por **US$ 5 no seu primeiro mês**, depois **US$ 10/mês**.

---

## Como funciona

O KiyoCode Go funciona como qualquer outro provedor no KiyoCode.

1. Você entra no **<a href={console}>KiyoCode Zen</a>**, assina o Go e
...
:::note
Apenas um membro por workspace pode assinar o KiyoCode Go.
:::
...
O KiyoCode Go inclui os seguintes limites:
...
O [ID do modelo](/docs/config/#models) na sua configuração do KiyoCode
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o KiyoCode também.
