---
title: TUI
description: Usando a interface de usuário de terminal kiyocode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O kiyocode fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar kiyocode inicia o TUI para o diretório atual.
...
Ao usar o TUI do kiyocode, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao kiyocode. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do kiyocode. _Aliases_: `/quit`, `/q`
...
- `leader_timeout` - Controla por quanto tempo o KiyoCode espera depois da leader key. O padrão é `2000`.
