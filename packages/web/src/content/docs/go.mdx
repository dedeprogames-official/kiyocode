...
KiyoCode Go is a low cost subscription — **$5 for your first month**, then **$10/month** — that gives you reliable access to popular open coding models.

Go works like any other provider in KiyoCode. You subscribe to KiyoCode Go and
...
KiyoCode Go gives you access to these models for **$5 for your first month**, then **$10/month**.

---

## How it works

KiyoCode Go works like any other provider in KiyoCode.

1. You sign in to **<a href={console}>KiyoCode Zen</a>**, subscribe to Go, and
   copy your API key.
...
:::note
Only one member per workspace can subscribe to KiyoCode Go.
:::
...
KiyoCode Go includes the following limits:
...
4. Have **no lock-in** by allowing you to use any other provider with KiyoCode as well.
