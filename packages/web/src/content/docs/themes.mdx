...
With KiyoCode you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, KiyoCode uses our own `opencode` theme.
...
KiyoCode comes with several built-in themes.
...
- Want KiyoCode to match their terminal's appearance
...
KiyoCode supports a flexible JSON-based theme system that allows users to create and customize themes easily.
