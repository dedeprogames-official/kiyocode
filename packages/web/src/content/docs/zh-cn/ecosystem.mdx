---
title: 生态系统
description: 基于 KiyoCode 构建的项目与集成。
---

基于 KiyoCode 构建的社区项目合集。

:::note
想将您的 KiyoCode 相关项目添加到此列表中？欢迎提交 PR。
:::

您还可以查看 [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) 和 [kiyocode.cafe](https://kiyocode.cafe)，这是一个聚合生态系统与社区资源的社区。
...
| 名称                                                                                               | 描述                                                                   |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔离的 Daytona 沙箱中自动运行 KiyoCode 会话，支持 git 同步和实时预览 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追踪 KiyoCode 的使用情况                                 |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | 后台代理、预构建的 LSP/AST/MCP 工具、精选代理，兼容 Claude Code        |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | KiyoCode 会话的桌面通知和声音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 针对权限请求、任务完成和错误事件的桌面通知与声音提醒                   |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基于 KiyoCode 上下文的 AI 驱动自动 Zellij 会话命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允许 KiyoCode 代理通过技能发现和注入按需延迟加载提示词                 |
| [opencode-supermemory](https://github.com/supermemoryai/opencode-supermemory)                      | 使用 Supermemory 实现跨会话的持久记忆                                  |
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | 支持可视化标注和私有/离线分享的交互式计划审查                          |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 将 KiyoCode /commands 扩展为具有精细流程控制的强大编排系统             |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | KiyoCode 的原生操作系统通知——随时了解任务完成情况                      |
...
| 名称                                                                                       | 描述                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | 用于控制 KiyoCode 会话的 Discord 机器人，基于 SDK 构建        |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Neovim 插件，提供编辑器感知的提示词，基于 API 构建            |
| [portal](https://github.com/hosenur/portal)                                                | 通过 Tailscale/VPN 使用的移动优先 KiyoCode Web UI             |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用于构建 KiyoCode 插件的模板                                  |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | KiyoCode 的 Neovim 前端——基于终端的 AI 编码代理               |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用于通过 @opencode-ai/sdk 使用 KiyoCode |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | KiyoCode 的 Web / 桌面应用和 VS Code 扩展                     |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 将 KiyoCode 嵌入 Obsidian UI 的 Obsidian 插件                 |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Claude Cowork 的开源替代方案，由 KiyoCode 驱动                |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | KiyoCode 扩展管理器，支持可移植的隔离配置                     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | KiyoCode 的桌面、Web、移动和远程客户端应用                    |
