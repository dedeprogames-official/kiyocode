---
title: 分享
description: 分享您的 KiyoCode 对话。
---

KiyoCode 的分享功能允许您创建指向 KiyoCode 对话的公开链接，方便与团队成员协作或向他人寻求帮助。
...
KiyoCode 支持三种分享模式，用于控制对话的共享方式：

---

### 手动模式（默认）

默认情况下，KiyoCode 使用手动分享模式。会话不会自动共享，但您可以使用 `/share` 命令手动分享：
...
[了解更多](/docs/enterprise)关于在您的组织中使用 KiyoCode 的信息。
