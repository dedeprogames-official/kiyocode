...
カスタムコマンドは、KiyoCode 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

KiyoCode [設定](/docs/config)で `command` オプションを使用します:
...
KiyoCode には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
