...
Le skill degli agenti permettono a KiyoCode di individuare istruzioni riutilizzabili dal tuo repo o dalla home directory.
...
KiyoCode cerca in queste posizioni:
...
Per i percorsi locali al progetto, KiyoCode risale dalla directory di lavoro corrente finche' non raggiunge il worktree git.
...
KiyoCode elenca le skill disponibili nella descrizione dello strumento `skill`.
