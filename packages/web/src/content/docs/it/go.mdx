...
KiyoCode Go è un abbonamento a basso costo — **5 $ per il primo mese**, poi **10 $/mese** — che ti offre un accesso affidabile ai popolari modelli di programmazione aperti.

Go funziona come qualsiasi altro provider in KiyoCode. Ti abboni a KiyoCode Go e
...
KiyoCode Go ti dà accesso a questi modelli a **5 $ per il primo mese**, poi a **10 $/mese**.

---

## Come funziona

KiyoCode Go funziona come qualsiasi altro provider in KiyoCode.

1. Accedi a **<a href={console}>KiyoCode Zen</a>**, ti abboni a Go e
...
:::note
Solo un membro per workspace può abbonarsi a KiyoCode Go.
:::
...
KiyoCode Go include i seguenti limiti:
...
Il [model id](/docs/config/#models) nella tua KiyoCode config
...
Abbiamo creato KiyoCode Go per:
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con KiyoCode.
