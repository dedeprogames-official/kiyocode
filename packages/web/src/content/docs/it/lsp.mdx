---
title: Server LSP
description: KiyoCode si integra con i tuoi server LSP.
---

KiyoCode può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

KiyoCode include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e kiyocode apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di kiyocode.
