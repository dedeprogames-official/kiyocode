---
title: Ecosistema
description: Progetti e integrazioni costruiti con KiyoCode.
---

Una raccolta di progetti della comunità costruiti su KiyoCode.

:::note
Vuoi aggiungere il tuo progetto legato a KiyoCode a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) e [kiyocode.cafe](https://kiyocode.cafe), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni KiyoCode in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di KiyoCode con Wakatime                                                            |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni KiyoCode                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto KiyoCode                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti KiyoCode di caricare prompt al bisogno con discovery e injection di skill    |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Revisione interattiva dei piani con annotazione visiva e condivisione privata/offline             |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende kiyocode /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per KiyoCode: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per KiyoCode                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni KiyoCode, costruito sull'SDK    |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per KiyoCode su Tailscale/VPN                    |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin KiyoCode                               |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Frontend Neovim per kiyocode: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare KiyoCode tramite @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per KiyoCode                   |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra KiyoCode nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da KiyoCode      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni KiyoCode con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per KiyoCode                |
