...
KiyoCode supporta le variabili d'ambiente standard per i proxy e certificati personalizzati per ambienti di rete enterprise.

---

## Proxy

KiyoCode rispetta le variabili d'ambiente standard dei proxy.
...
Se la tua organizzazione usa CA personalizzate per connessioni HTTPS, configura KiyoCode in modo che si fidi di esse.
