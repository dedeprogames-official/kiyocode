---
title: Zen
description: Lista curata di modelli fornita da KiyoCode.
---
...
KiyoCode Zen è un elenco di modelli testati e verificati forniti dal team di KiyoCode.

Zen funziona come qualsiasi altro provider in KiyoCode. Accedi a KiyoCode Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con KiyoCode.
:::
...
KiyoCode Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

KiyoCode Zen funziona come qualsiasi altro provider in KiyoCode.

1. Accedi a **<a href={console}>KiyoCode Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona KiyoCode Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di KiyoCode
...
- DeepSeek V4 Flash Free è disponibile su KiyoCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su KiyoCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su KiyoCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su KiyoCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su KiyoCode per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato KiyoCode Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con KiyoCode.
