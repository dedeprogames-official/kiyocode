...
Agent skills let KiyoCode discover reusable instructions from your repo or home directory.
...
KiyoCode searches these locations:
...
For project-local paths, KiyoCode walks up from your current working directory until it reaches the git worktree.
...
KiyoCode lists available skills in the `skill` tool description.
