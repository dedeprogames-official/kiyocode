---
title: TUI
description: استخدام واجهة المستخدم TUI في KiyoCode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر KiyoCode واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل KiyoCode إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة KiyoCode في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى KiyoCode. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من KiyoCode. _الأسماء المستعارة_: `/quit`, `/q`
...
- `leader_timeout` - يتحكم في مدة انتظار KiyoCode بعد الضغط على leader key. القيمة الافتراضية `2000`.
