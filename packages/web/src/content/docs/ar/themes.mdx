...
مع KiyoCode يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم KiyoCode سمتنا `opencode`.
...
يأتي KiyoCode مع عدة سمات مدمجة.
...
- يريدون أن يطابق KiyoCode مظهر terminal لديهم
...
يدعم KiyoCode نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
