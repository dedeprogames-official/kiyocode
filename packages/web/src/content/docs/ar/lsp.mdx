---
title: خوادم LSP
description: يتكامل KiyoCode مع خوادم LSP لديك.
---

يمكن أن يتكامل KiyoCode مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي KiyoCode مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح kiyocode لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات kiyocode.
