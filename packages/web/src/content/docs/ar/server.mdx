---
title: الخادم
description: تفاعل مع خادم kiyocode عبر HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

يشغّل الأمر `opencode serve` خادما HTTP دون واجهة ويعرض نقطة نهاية OpenAPI يمكن لعميل kiyocode استخدامها.
...
:::tip
استخدم خادم kiyocode للتفاعل مع kiyocode برمجيا.
:::

تتيح هذه البنية لـ kiyocode دعم عدة عملاء وتمكّنك من التفاعل مع kiyocode برمجيا.

يمكنك تشغيل `opencode serve` لبدء خادم مستقل. إذا كانت واجهة kiyocode في terminal (TUI)
...
يمكن استخدام نقطة النهاية [`/tui`](#tui) للتحكم في الـ TUI عبر الخادم. على سبيل المثال، يمكنك تعبئة الموجّه مسبقا أو تشغيله. يُستخدم هذا الإعداد بواسطة ملحقات KiyoCode لـ [IDE](/docs/ide).
...
يعرض خادم kiyocode واجهات API التالية.
