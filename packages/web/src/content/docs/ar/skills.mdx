...
تتيح مهارات الوكيل لـ KiyoCode اكتشاف تعليمات قابلة لإعادة الاستخدام من مستودعك أو من دليل المنزل.
...
بالنسبة لمسارات المشروع المحلية، يتدرج KiyoCode صعوداً من دليل العمل الحالي حتى يصل إلى `git worktree`.
...
يعرض KiyoCode المهارات المتاحة في وصف أداة `skill`.
