---
title: النظام البيئي
description: مشاريع وتكاملات مبنية باستخدام KiyoCode.
---

مجموعة من مشاريع المجتمع المبنية على KiyoCode.

:::note
هل تريد إضافة مشروعك المتعلق بـ KiyoCode إلى هذه القائمة؟ أرسل طلب سحب (PR).
:::

يمكنك أيضًا الاطلاع على [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) و [kiyocode.cafe](https://kiyocode.cafe)، وهو مجتمع يجمع النظام البيئي والمجتمع.
...
| الاسم                                                                                              | الوصف                                                                                                          |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | تشغيل جلسات KiyoCode تلقائيًا في صناديق حماية Daytona معزولة مع مزامنة git ومعاينات حية                        |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | تتبع استخدام KiyoCode باستخدام Wakatime                                                                        |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | وكلاء الخلفية، وأدوات LSP/AST/MCP المعدة مسبقًا، ووكلاء مختارون، متوافق مع Claude Code                         |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | إشعارات سطح المكتب وتنبيهات صوتية لجلسات KiyoCode                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | تسمية جلسات Zellij تلقائيًا بدعم الذكاء الاصطناعي بناءً على سياق KiyoCode                                      |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | السماح لوكلاء KiyoCode بتحميل المطالبات (prompts) بشكل كسول عند الطلب مع اكتشاف المهارات وحقنها                |
| [opencode-supermemory](https://github.com/supermemoryai/opencode-supermemory)                      | ذاكرة مستمرة عبر الجلسات باستخدام Supermemory                                                                  |
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | مراجعة تفاعلية للخطة مع تعليقات توضيحية مرئية ومشاركة خاصة/بدون اتصال                                          |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | توسيع kiyocode /commands إلى نظام تنسيق قوي مع تحكم دقيق في التدفق                                             |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | إشعارات نظام التشغيل الأصلية لـ KiyoCode – اعرف متى تكتمل المهام                                               |
| [opencode-workspace](https://github.com/kdcokenny/opencode-workspace)                              | حزمة تنسيق متعددة الوكلاء – 16 مكونًا، تثبيت واحد                                                              |
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | أشجار عمل git (worktrees) خالية من الاحتكاك لـ KiyoCode                                                        |
...
| الاسم                                                                                      | الوصف                                                                     |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | بوت Discord للتحكم في جلسات KiyoCode، مبني على SDK                        |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | إضافة Neovim للمطالبات المدركة للمحرر، مبنية على API                      |
| [portal](https://github.com/hosenur/portal)                                                | واجهة ويب مخصصة للجوال لـ KiyoCode عبر Tailscale/VPN                      |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | قالب لبناء إضافات KiyoCode                                                |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | واجهة Neovim لـ kiyocode - وكيل برمجة بالذكاء الاصطناعي يعتمد على الطرفية |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | موفر Vercel AI SDK لاستخدام KiyoCode عبر @opencode-ai/sdk                 |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | تطبيق ويب / سطح مكتب وامتداد VS Code لـ KiyoCode                          |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | إضافة Obsidian تدمج KiyoCode في واجهة مستخدم Obsidian                     |
| [OpenWork](https://github.com/different-ai/openwork)                                       | بديل مفتوح المصدر لـ Claude Cowork، مدعوم بواسطة KiyoCode                 |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | مدير امتدادات KiyoCode مع ملفات تعريف محمولة ومعزولة.                     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | تطبيق عميل لسطح المكتب والويب والجوال وعن بعد لـ KiyoCode                 |
