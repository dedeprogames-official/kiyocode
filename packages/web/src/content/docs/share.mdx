---
title: Share
description: Share your KiyoCode conversations.
---

KiyoCode's share feature allows you to create public links to your KiyoCode conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, KiyoCode:
...
KiyoCode supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, KiyoCode uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
[Learn more](/docs/enterprise) about using kiyocode in your organization.
