---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala kiyocode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

kiyocode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie kiyocode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI kiyocode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do kiyocode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij kiyocode. _Aliasy_: `/quit`, `/q`
...
- `leader_timeout` - Określa, jak długo KiyoCode czeka po naciśnięciu leader key. Domyślnie `2000`.
