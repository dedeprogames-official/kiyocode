---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące kiyocode.
---

Funkcja udostępniania kiyocode umożliwia tworzenie publicznych linków do konwersacji kiyocode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, kiyocode:
...
kiyocode obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie kiyocode korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
[Dowiedz się więcej](/docs/enterprise) o używaniu kiyocode w Twojej organizacji.
