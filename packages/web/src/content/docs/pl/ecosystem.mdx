---
title: Ekosystem
description: Projekty i integracje zbudowane przy użyciu KiyoCode.
---

Zbiór projektów społeczności zbudowanych na KiyoCode.

:::note
Chcesz dodać swój projekt związany z KiyoCode do tej listy? Prześlij PR.
:::

Możesz również sprawdzić [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) oraz [kiyocode.cafe](https://kiyocode.cafe), społeczność agregującą ekosystem i społeczność.
...
| Nazwa                                                                                              | Opis                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatyczne uruchamianie sesji KiyoCode w izolowanych piaskownicach Daytona z synchronizacją git i podglądem na żywo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Śledź użycie KiyoCode za pomocą Wakatime                                                                              |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Agenci w tle, wbudowane narzędzia LSP/AST/MCP, wyselekcjonowani agenci, kompatybilność z Claude Code                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Powiadomienia na pulpicie i alerty dźwiękowe dla sesji KiyoCode                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatyczne nazywanie sesji Zellij oparte na AI w oparciu o kontekst KiyoCode                                        |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Pozwól agentom KiyoCode na leniwe ładowanie promptów na żądanie z odkrywaniem umiejętności i wstrzykiwaniem           |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktywny przegląd planów z wizualnymi adnotacjami i prywatnym/offline udostępnianiem                              |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Rozszerz komendy /commands KiyoCode w potężny system orkiestracji ze szczegółową kontrolą przepływu                   |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Natywne powiadomienia systemowe dla KiyoCode – wiedz, kiedy zadania się zakończą                                      |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Bezproblemowe drzewa robocze git dla KiyoCode                                                                         |
...
| Nazwa                                                                                      | Opis                                                                    |
| ------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord do sterowania sesjami KiyoCode, zbudowany na SDK            |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Wtyczka Neovim dla promptów świadomych edytora, zbudowana na API        |
| [portal](https://github.com/hosenur/portal)                                                | Interfejs webowy mobile-first dla KiyoCode przez Tailscale/VPN          |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Szablon do tworzenia wtyczek KiyoCode                                   |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Frontend Neovim dla KiyoCode - terminalowy agent kodujący AI            |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Dostawca Vercel AI SDK do używania KiyoCode przez @opencode-ai/sdk      |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplikacja Web / Desktop i rozszerzenie VS Code dla KiyoCode             |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Wtyczka Obsidian osadzająca KiyoCode w interfejsie Obsidian             |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Otwartoźródłowa alternatywa dla Claude Cowork, napędzana przez KiyoCode |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Menedżer rozszerzeń KiyoCode z przenośnymi, izolowanymi profilami.      |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplikacja kliencka Desktop, Web, Mobile i Remote dla KiyoCode           |
