---
title: Serwery LSP
description: KiyoCode integruje się z serwerami LSP.
---

KiyoCode może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

KiyoCode posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i KiyoCode otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji KiyoCode.
