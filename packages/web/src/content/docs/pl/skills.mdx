...
Umiejętności agenta pozwalają kiyocode odkryć instrukcje wielokrotnego użytku z repozytorium lub katalogu domowego.
...
kiyocode przeszukuje te lokalizacje:
...
W przypadku ścieżek lokalnych projektu kiyocode przechodzi od bieżącego katalogu roboczego, aż dotrze do drzewa roboczego git.
...
kiyocode wymienia dostępne umiejętności w opisie narzędzia `skill`.
