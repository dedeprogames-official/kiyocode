...
KiyoCode Go to niskokosztowa subskrypcja — **5 $ za pierwszy miesiąc**, a następnie **10 $/miesiąc** — która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania.

Go działa jak każdy inny dostawca w KiyoCode. Subskrybujesz KiyoCode Go i
...
KiyoCode Go daje Ci dostęp do tych modeli za **5 $ za pierwszy miesiąc**, a następnie **10 $/miesiąc**.

---

## Jak to działa

KiyoCode Go działa jak każdy inny dostawca w KiyoCode.

1. Logujesz się do **<a href={console}>KiyoCode Zen</a>**, subskrybujesz Go i
...
:::note
Tylko jeden członek na obszar roboczy (workspace) może zasubskrybować KiyoCode Go.
:::
...
KiyoCode Go zawiera następujące limity:
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji KiyoCode
...
4. Zapewnić **brak ograniczeń (no lock-in)**, pozwalając na korzystanie z dowolnego innego dostawcy wraz z KiyoCode.
