...
Dzięki kiyocode możesz wybrać jeden z kilku wbudowanych motywów, użyć motywu, który dostosowuje się do motywu terminala lub zdefiniować własny, niestandardowy motyw.

Domyślnie kiyocode używa naszego własnego motywu `opencode`.
...
kiyocode ma kilka wbudowanych motywów.
...
- Chcą, aby KiyoCode pasował do wyglądu ich terminala
...
kiyocode obsługuje elastyczny system motywów oparty na JSON, który pozwala użytkownikom łatwo tworzyć i dostosowywać motywy.
