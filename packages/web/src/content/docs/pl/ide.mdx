---
title: IDE
description: Rozszerzenie kiyocode dla VS Code, Cursor i innych IDE
---

kiyocode integruje się z VS Code, Cursorem lub obsługującym terminal IDE. Aby uruchomić, po prostu uruchom `opencode` w terminalu.

---

## Stosowanie

- **Szybkie uruchomienie**: użycie `Cmd+Esc` (Mac) lub `Ctrl+Esc` (Windows/Linux), aby uruchomić kiyocode w uruchamianiu terminala lub skoncentruj się na uruchamianiu terminala, jeśli jest już uruchomiony.
- **Nowa sesja**: `Cmd+Shift+Esc` (Mac) lub `Ctrl+Shift+Esc` (Windows/Linux), aby została nowa konfiguracja terminala kiyocode, nawet jeśli jest już otwarta. Możesz także kliknąć przycisk kiyocode w interfejsie użytkownika.
- **Świadomość kontekstu**: Automatycznie udostępnia wybór lub kartę za pomocą kiyocode.
...
Aby poznać kiyocode na VS Code w forkach, takich jak Cursor, Windsurf, VSCodium:
...
Wyszukaj **kiyocode** na rynku rozszerzonym i kliknij **Zainstaluj**.
