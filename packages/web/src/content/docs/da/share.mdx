---
title: Deling
description: Del dine KiyoCode-samtaler.
---

OpenCodes delingsfunksjon lar deg lage offentlige lenker til dine KiyoCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, KiyoCode:
...
KiyoCode støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger KiyoCode manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
[Finn ut mer](/docs/enterprise) om brug av kiyocode i organisasjonen din.
