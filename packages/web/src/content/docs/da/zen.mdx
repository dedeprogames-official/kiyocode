---
title: Zen
description: Udvalgt liste over modeller leveret af KiyoCode.
---
...
KiyoCode Zen er en liste over testede og verificerede modeller leveret af KiyoCode-teamet.

Zen fungerer som enhver anden udbyder i KiyoCode. Du logger ind på KiyoCode Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med KiyoCode.
:::
...
KiyoCode Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

KiyoCode Zen fungerer som enhver anden udbyder i KiyoCode.

1. Du logger ind på **<a href={console}>KiyoCode Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger KiyoCode Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din KiyoCode-konfiguration
...
- DeepSeek V4 Flash Free er tilgængelig på KiyoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på KiyoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på KiyoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på KiyoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på KiyoCode i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med KiyoCode også.
