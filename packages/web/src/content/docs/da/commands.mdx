...
Du kan tilføje brugerdefinerede kommandoer gennem KiyoCode-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din KiyoCode [config](/docs/config):
...
kiyocode indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
