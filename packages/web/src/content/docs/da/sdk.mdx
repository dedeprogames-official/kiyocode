...
Brug den til at bygge integrasjoner og kontrollere kiyocode programmatisk.
...
Opret en forekomst av kiyocode:
...
Hvis du allerede har en kjørende forekomst av kiyocode, kan du oprete en klientforekomst for at koble til den:
