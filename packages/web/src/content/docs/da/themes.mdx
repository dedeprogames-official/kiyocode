...
Med KiyoCode kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger KiyoCode vårt eget `opencode`-tema.
...
KiyoCode kommer med flere innebygde temaer.
...
- Vil at KiyoCode skal matche terminalens utseende
...
KiyoCode støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
