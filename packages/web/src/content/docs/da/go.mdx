...
KiyoCode Go er et lavprisabonnement — **$5 for din første måned**, derefter **$10/måned** — der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i KiyoCode. Du abonnerer på KiyoCode Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med KiyoCode.
:::
...
KiyoCode Go giver dig adgang til disse modeller for **$5 for din første måned**, derefter **$10/måned**.

---

## Sådan fungerer det

KiyoCode Go fungerer som enhver anden udbyder i KiyoCode.

1. Du logger ind på **<a href={console}>KiyoCode Zen</a>**, abonnerer på Go, og
...
:::note
Kun ét medlem per arbejdsområde kan abonnere på KiyoCode Go.
:::
...
KiyoCode Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din KiyoCode config
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med KiyoCode.
