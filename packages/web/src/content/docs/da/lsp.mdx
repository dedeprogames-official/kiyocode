---
title: LSP-servere
description: KiyoCode integreres med dine LSP-servere.
---

KiyoCode kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

KiyoCode leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og kiyocode åbner en fil, vil den:
