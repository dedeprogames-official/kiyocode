---
title: Økosystem
description: Prosjekter og integrasjoner bygget med KiyoCode.
---

En samling fellesskapsprosjekter bygget på KiyoCode.

:::note
Vil du legge til ditt KiyoCode-relaterte prosjekt til denne listen? Send inn en PR.
:::

Du kan også sjekke ut [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) og [kiyocode.cafe](https://kiyocode.cafe), et fellesskap som samler økosystemet og fellesskapet.
...
| Navn                                                                                               | Beskrivelse                                                                                                   |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Kjør KiyoCode-økter automatisk i isolerte Daytona-sandkasser med git-synkronisering og live-forhåndsvisninger |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor KiyoCode-bruk med Wakatime                                                                               |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Bakgrunnsagenter, forhåndsbygde LSP/AST/MCP verktøy, kurerte agenter, Claude Code-kompatibel                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Skrivebordsvarsler og lydvarsler for KiyoCode-økter                                                           |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-drevet automatisk Zellij-sesjonsnavn basert på KiyoCode-kontekst                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Tillat KiyoCode-agenter å lazy-loade meldinger på forespørsel med ferdighetsoppdagelse og injeksjon           |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktiv plangjennomgang med visuell merknad og privat/offline deling                                       |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid KiyoCode /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for KiyoCode – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for KiyoCode                                                                      |
...
| Navn                                                                                       | Beskrivelse                                                         |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-bot for å kontrollere KiyoCode-økter, bygget på SDK         |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Neovim-plugin for editor-tilpassede meldinger, bygget på API        |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for KiyoCode over Tailscale/VPN                 |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge KiyoCode-plugins                                    |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Neovim-grensesnitt for KiyoCode - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av KiyoCode via @opencode-ai/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for KiyoCode               |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn KiyoCode i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av KiyoCode  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | KiyoCode utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for KiyoCode              |
