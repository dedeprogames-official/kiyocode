...
Agentferdigheter lar KiyoCode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
kiyocode søker etter disse stedene:
...
For prosjektlokale stier går kiyocode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
kiyocode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
