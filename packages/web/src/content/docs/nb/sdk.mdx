---
title: SDK
description: Typesikker JS-klient for KiyoCode-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

KiyoCode JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere KiyoCode programmatisk.
...
Opprett en forekomst av KiyoCode:
...
Hvis du allerede har en kjørende forekomst av KiyoCode, kan du opprette en klientforekomst for å koble til den:
