---
title: ACP-støtte
description: Bruk kiyocode i en hvilken som helst ACP-kompatibel editor.
---

KiyoCode støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke KiyoCode via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `opencode acp`.

Kommandoen starter KiyoCode som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'KiyoCode'-agenten i AI Chat-agentvelgeren.
...
For å bruke KiyoCode som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke KiyoCode som ACP-agent for chat.
...
KiyoCode fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i KiyoCode-konfigurasjonen
