---
title: LSP-servere
description: kiyocode integreres med LSP-serverne dine.
---

KiyoCode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

KiyoCode kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og kiyocode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i KiyoCode-konfigurasjonen.
