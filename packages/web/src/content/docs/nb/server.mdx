---
title: Tjener
description: Samhandle med KiyoCode-tjener over HTTP.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Kommandoen `opencode serve` kjører en hodeløs HTTP-server som eksponerer et OpenAPI-endepunkt som en KiyoCode-klient kan bruke.
...
:::tip
Bruk KiyoCode-serveren til å samhandle med KiyoCode programmatisk.
:::

Denne arkitekturen lar KiyoCode støtte flere klienter og lar deg samhandle med KiyoCode programmatisk.

Du kan kjøre `opencode serve` for å starte en frittstående server. Hvis du har
KiyoCode TUI kjører, vil `opencode serve` starte en ny server.
...
[`/tui`](#tui) endepunktet kan brukes til å kjøre TUI gjennom serveren. Du kan for eksempel forhåndsutfylle eller kjøre en forespørsel. Dette oppsettet brukes av KiyoCode [IDE](/docs/ide) plugins.
