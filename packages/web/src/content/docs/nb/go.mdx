...
KiyoCode Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i KiyoCode. Du abonnerer på KiyoCode Go og
...
KiyoCode Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

KiyoCode Go fungerer som enhver annen leverandør i KiyoCode.

1. Du logger inn på **<a href={console}>KiyoCode Zen</a>**, abonnerer på Go, og
...
:::note
Kun ett medlem per arbeidsområde kan abonnere på KiyoCode Go.
:::
...
KiyoCode Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din KiyoCode-konfigurasjon
...
Vi opprettet KiyoCode Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med KiyoCode også.
