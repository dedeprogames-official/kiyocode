...
description: Lag verktøy som LLM kan kalle inn KiyoCode.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med KiyoCode sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
