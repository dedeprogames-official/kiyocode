---
title: Zen
description: Utvalgt liste over modeller levert av KiyoCode.
---
...
KiyoCode Zen er en liste over testede og verifiserte modeller levert av KiyoCode-teamet.

Zen fungerer som enhver annen leverandør i KiyoCode. Du logger inn på KiyoCode Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med KiyoCode.
:::
...
KiyoCode Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

KiyoCode Zen fungerer som enhver annen leverandør i KiyoCode.

1. Du logger inn på **<a href={console}>KiyoCode Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger KiyoCode Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i KiyoCode-konfigurasjonen din
...
- DeepSeek V4 Flash Free er tilgjengelig på KiyoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på KiyoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på KiyoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på KiyoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på KiyoCode i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet KiyoCode Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med KiyoCode også.
