...
Det er to typer agenter i KiyoCode; primære agenter og underagenter.
...
KiyoCode kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
KiyoCode kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

KiyoCode kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Hvis ingen temperatur er spesifisert, bruker KiyoCode modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale KiyoCode-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i KiyoCode-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [KiyoCode Zen](/docs/zen), vil du bruke `opencode/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/dedeprogames-official/kiyocode).
:::
