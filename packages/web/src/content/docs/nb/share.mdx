...
Delingsfunksjonen i KiyoCode lar deg lage offentlige lenker til dine KiyoCode-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Som standard bruker KiyoCode manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
[Finn ut mer](/docs/enterprise) om bruk av kiyocode i organisasjonen din.
