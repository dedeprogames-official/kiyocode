---
title: SDK
description: Типобезопасный JS-клиент для сервера kiyocode.
---
...
Если у вас уже есть работающий экземпляр kiyocode, вы можете создать экземпляр клиента для подключения к нему:
