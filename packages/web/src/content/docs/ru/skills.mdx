...
Навыки агента позволяют kiyocode обнаруживать многократно используемые инструкции из вашего репозитория или домашнего каталога.
...
kiyocode выполняет поиск в следующих местах:
...
Для локальных путей проекта kiyocode переходит из вашего текущего рабочего каталога, пока не достигнет рабочего дерева git.
...
kiyocode перечисляет доступные навыки в описании инструмента `skill`.
