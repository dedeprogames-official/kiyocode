...
Mit KiyoCode kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet KiyoCode das `opencode`-Theme.
...
KiyoCode liefert mehrere eingebaute Themes mit.
...
- KiyoCode optisch ans Terminal anpassen wollen
...
KiyoCode unterstuetzt ein flexibles JSON-basiertes Theme-System.
