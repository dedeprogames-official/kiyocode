---
title: Web
description: Verwenden Sie KiyoCode in Ihrem Browser.
---

KiyoCode kann als Webanwendung in Ihrem Browser ausgeführt werden und bietet das gleiche leistungsstarke KI-Codierungserlebnis, ohne dass ein Terminal erforderlich ist.

![KiyoCode Web – Neue Sitzung](../../../assets/web/web-homepage-new-session.png)
...
Dadurch wird ein lokaler Server auf `127.0.0.1` mit einem zufällig verfügbaren Port gestartet und KiyoCode automatisch in Ihrem Standardbrowser geöffnet.
...
Standardmäßig wählt KiyoCode einen verfügbaren Port aus. Sie können einen Port angeben:
...
Standardmäßig bindet der Server an `127.0.0.1` (nur localhost). So machen Sie KiyoCode in Ihrem Netzwerk zugänglich:

```bash
opencode web --hostname 0.0.0.0
```

Bei Verwendung von `0.0.0.0` zeigt KiyoCode sowohl lokale als auch Netzwerkadressen an:
...
Nach dem Start bietet die Weboberfläche Zugriff auf Ihre KiyoCode-Sitzungen.

### Sitzungen

Zeigen Sie Ihre Sitzungen auf der Startseite an und verwalten Sie sie. Sie können aktive Sitzungen sehen und neue starten.

![KiyoCode Web – Aktive Sitzung](../../../assets/web/web-homepage-active-session.png)

### Serverstatus

Klicken Sie auf „Server anzeigen“, um verbundene Server und deren Status anzuzeigen.

![KiyoCode Web – Siehe Server](../../../assets/web/web-homepage-see-servers.png)
