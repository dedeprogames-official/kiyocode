---
title: Ökosystem
description: Mit KiyoCode erstellte Projekte und Integrationen.
---

Eine Sammlung von Community-Projekten, die auf KiyoCode basieren.

:::note
Möchten Sie Ihr KiyoCode-bezogenes Projekt zu dieser Liste hinzufügen? Senden Sie einen PR.
:::

Sie können sich auch [awesome-kiyocode](https://github.com/awesome-kiyocode/awesome-kiyocode) und [kiyocode.cafe](https://kiyocode.cafe) ansehen, eine Community, die das Ökosystem und die Community zusammenfasst.
...
| Name                                                                                               | Beschreibung                                                                                                                  |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Führen Sie KiyoCode-Sitzungen automatisch in isolierten Daytona-Sandboxes mit Git-Synchronisierung und Live-Vorschauen aus    |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Verfolgen Sie die Nutzung von KiyoCode mit Wakatime                                                                           |
...
| [oh-my-kiyocode](https://github.com/code-yeongyu/oh-my-kiyocode)                                   | Hintergrundagenten, vorgefertigte LSP/AST/MCP-Tools, kuratierte Agenten, Claude Code-kompatibel                               |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop-Benachrichtigungen und akustische Warnungen für KiyoCode-Sitzungen                                                    |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-gestützte automatische Benennung von Zellij-Sitzungen basierend auf dem KiyoCode-Kontext                                   |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Ermöglichen Sie KiyoCode-Agenten das verzögerte Laden von Eingabeaufforderungen bei Bedarf mit Skill-Erkennung und -Injektion |
...
| [@plannotator/kiyocode](https://github.com/backnotprop/plannotator/tree/main/apps/opencode-plugin) | Interaktive Planüberprüfung mit visueller Anmerkung und private/offline-Freigabe                                              |
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Erweitern Sie KiyoCode /commands zu einem leistungsstarken Orchestrierungssystem mit granularer Flusskontrolle                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-Benachrichtigungen für KiyoCode – wissen, wann Aufgaben erledigt sind                                               |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Reibungslose Git-Arbeitsbäume für KiyoCode                                                                                    |
...
| Name                                                                                       | Beschreibung                                                                 |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord-Bot zur Steuerung von KiyoCode-Sitzungen, basierend auf SDK          |
| [kiyocode.nvim](https://github.com/NickvanDyke/kiyocode.nvim)                              | Neovim-Plugin für editorfähige Eingabeaufforderungen, basierend auf API      |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-First-Web UI für KiyoCode über Tailscale/VPN                          |
| [kiyocode plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Vorlage zum Erstellen von KiyoCode-Plugins                                   |
| [kiyocode.nvim](https://github.com/sudo-tee/kiyocode.nvim)                                 | Neovim-Frontend für KiyoCode – ein terminalbasierter AI-Coding-Agent         |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK Anbieter für die Verwendung von KiyoCode über @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/Desktop-App und VS Code-Erweiterung für KiyoCode                        |
| [KiyoCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-Plugin, das KiyoCode in Obsidians UI einbettet                      |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Eine Open-Source-Alternative zu Claude Cowork, unterstützt von KiyoCode      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | KiyoCode Erweiterungsmanager mit portablen, isolierten Profilen.             |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, Web-, Mobil- und Remote-Client-App für KiyoCode                    |
