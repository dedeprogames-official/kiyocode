---
title: TUI
description: Arbeite mit KiyoCode in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

KiyoCode bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet KiyoCode die TUI im aktuellen Verzeichnis.
...
In der KiyoCode-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu KiyoCode hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet KiyoCode. _Aliase_: `/quit`, `/q`
...
- `leader_timeout` - Steuert, wie lange KiyoCode nach der leader key wartet. Standard ist `2000`.
