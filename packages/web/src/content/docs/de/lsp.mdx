---
title: LSP Server
description: KiyoCode lässt sich in Ihren LSP-Server integrieren.
---

KiyoCode kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

KiyoCode verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und KiyoCode eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer KiyoCode-Konfiguration aktivieren und anpassen.
