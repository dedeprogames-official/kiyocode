...
Das kiyocode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und kiyocode programmatisch steuern.
...
Wenn kiyocode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
