---
title: Zen
description: Kuratierte Modellliste direkt von KiyoCode.
---
...
KiyoCode Zen ist eine Liste von getesteten und verifizierten Modellen, die vom KiyoCode-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in KiyoCode. Du meldest dich bei KiyoCode Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um KiyoCode zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit KiyoCode funktionieren.
:::
...
KiyoCode Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

KiyoCode Zen funktioniert wie jeder andere Provider in KiyoCode.

1. Du meldest dich bei **<a href={console}>KiyoCode Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst KiyoCode Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner KiyoCode-Konfiguration verwendet das Format `opencode/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `opencode/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf KiyoCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf KiyoCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- North Mini Code Free ist für begrenzte Zeit auf KiyoCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf KiyoCode verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf KiyoCode verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben KiyoCode Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit KiyoCode auch jeden anderen Provider zu verwenden.
