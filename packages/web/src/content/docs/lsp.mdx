---
title: LSP Servers
description: KiyoCode integrates with your LSP servers.
---

KiyoCode can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

KiyoCode comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and kiyocode opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your kiyocode config.
