...
- Secondary audience: KiyoCode and other durable agent runtimes
...
KiyoCode and other durable runtimes need to own persistence, tool settlement,
...
KiyoCode should migrate to `generateTurn` / `streamTurn`, preserving its durable
