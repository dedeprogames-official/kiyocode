...
brew install dedeprogames-official/tap/kiyocode # macOS 및 Linux (권장, 항상 최신)
brew install opencode              # macOS 및 Linux (공식 brew formula, 업데이트 빈도 낮음)
sudo pacman -S opencode            # Arch Linux (Stable)
paru -S opencode-bin               # Arch Linux (Latest from AUR)
mise use -g opencode               # 어떤 OS든
nix run nixpkgs#opencode           # 또는 github:dedeprogames-official/kiyocode 로 최신 dev 브랜치
```
...
KiyoCode 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/dedeprogames-official/kiyocode/releases) 에서 직접 다운로드하거나 [kiyocode.ai/download](https://kiyocode.ai/download) 를 이용하세요.
...
KiyoCode 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://kiyocode.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

KiyoCode 설정에 대한 자세한 내용은 [**문서**](https://kiyocode.ai/docs) 를 참고하세요.

### 기여하기

KiyoCode 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### KiyoCode 기반으로 만들기

KiyoCode 와 관련된 프로젝트를 진행하면서 이름에 "kiyocode"(예: "opencode-dashboard" 또는 "opencode-mobile") 를 포함한다면, README 에 해당 프로젝트가 KiyoCode 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/kiyocode) | [X.com](https://x.com/kiyocode)
